...
from .plotting  import Plotter, Opts, MyCustomToolbar, ColorMap, close_all, get_axes_scales, \
                           plot_time_history, plot_correlation_matrix, plot_multiline_history, \
                           plot_bar_breakdown, plot_bpe_convergence, storefig, titleprefix, \
...
from .utils     import rms, rss, setup_dir, compare_two_classes, compare_two_dicts, round_time, \
                           ...
                           delete_pyc, rename_module, modd, find_tabs, np_digitize
