...
class Test_aerospace_qrot_single(unittest.TestCase):
    ...
    def test_single_inputs(self) -> None:
        for i in range(len(self.axis)):
            ...
            self.assertEqual(quat.ndim, 1)
            np.testing.assert_array_almost_equal(quat, self.quat2[i, :], 14)
...
class Test_aerospace_quat_from_axis_angle_single(unittest.TestCase):
    ...
    def test_null_axis(self) -> None:
        ...
        np.testing.assert_array_equal(quat, np.array([0.0, 0.0, 0.0, 1.0]), 14)
...
class Test_aerospace_quat_angle_diff_single(unittest.TestCase):
    ...
    def test_nominal1(self) -> None:
        ...
        np.testing.assert_array_almost_equal(comp, self.comp1, 14)

    def test_nominal2(self) -> None:
        comp = space.quat_angle_diff_single(self.quat1, self.dqq2)
        np.testing.assert_array_almost_equal(comp, self.comp2, 14)
...
class Test_aerospace_quat_interp_single(unittest.TestCase):
    ...
    def test_nominal(self) -> None:
        ...
        np.testing.assert_array_almost_equal(qout, self.qout[:, 0], 14)
        ix = np.array([0, 1])
        ...
        np.testing.assert_array_almost_equal(qout, self.qout[:, 2], 14)
        ix = np.array([1, 2])
        qout = space.quat_interp_single(self.time[ix], self.quat[:, ix], self.ti[3])
        if qout[0] > 0:
            np.testing.assert_array_almost_equal(qout, self.qout[:, 3], 14)  # pragma: no cover
        else:
            np.testing.assert_array_almost_equal(qout, -self.qout[:, 3], 14)
...
class Test_aerospace_quat_inv_single(unittest.TestCase):
    ...
    def test_inplace(self) -> None:
        ...
        self.assertLess(np.max(np.abs(q1_inv - self.q1_inp)), 1e-14)
...
class Test_aerospace_quat_mult_single(unittest.TestCase):
    ...
    def test_nominal3(self) -> None:
        ...
        self.assertEqual(quat.ndim, 1)
        np.testing.assert_array_almost_equal(quat, space.quat_inv_single(self.q6), 14)
    ...
    def test_inplace(self) -> None:
        ...
        self.assertLess(np.max(np.abs(quat - self.q4)), 1e-14)
...
class Test_aerospace_quat_norm_single(unittest.TestCase):
    ...
    def test_inplace(self) -> None:
        ...
        self.assertLess(np.max(np.abs(quat_norm - self.q3_inp)), 1e-14)
...
class Test_aerospace_quat_to_dcm(unittest.TestCase):
    ...
    def test_nominal(self) -> None:
        ...
        np.testing.assert_array_almost_equal(dcm, self.dcm, 12)
