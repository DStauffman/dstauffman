...
class Test_health_convert_annual_to_monthly_probability(unittest.TestCase):
    ...
    def test_lt_zero(self) -> None:
        with self.assertRaises(ValueError):
            health.convert_annual_to_monthly_probability(np.array([0.0, 0.5, -1.0]))

    def test_gt_one(self) -> None:
        with self.assertRaises(ValueError):
            health.convert_annual_to_monthly_probability(np.array([0.0, 0.5, 1.5]))
...
class Test_health_convert_monthly_to_annual_probability(unittest.TestCase):
    ...
    def test_lt_zero(self) -> None:
        with self.assertRaises(ValueError):
            health.convert_monthly_to_annual_probability(np.array([0.0, 0.5, -1.0]))

    def test_gt_one(self) -> None:
        with self.assertRaises(ValueError):
            health.convert_monthly_to_annual_probability(np.array([0.0, 0.5, 1.5]))
...
class Test_health_prob_to_rate(unittest.TestCase):
    ...
    def test_lt_zero(self) -> None:
        with self.assertRaises(ValueError):
            health.prob_to_rate(np.array([0.0, 0.5, -1.0]))

    def test_gt_one(self) -> None:
        with self.assertRaises(ValueError):
            health.prob_to_rate(np.array([0.0, 0.5, 1.5]))
...
class Test_health_rate_to_prob(unittest.TestCase):
    ...
    def test_lt_zero(self) -> None:
        with self.assertRaises(ValueError):
            health.rate_to_prob(np.array([0.0, 0.5, -1.0]))
...
class Test_health_annual_rate_to_monthly_probability(unittest.TestCase):
    ...
    def test_lt_zero(self) -> None:
        with self.assertRaises(ValueError):
            health.annual_rate_to_monthly_probability(np.array([0.0, 0.5, -1.0]))
...
class Test_health_monthly_probability_to_annual_rate(unittest.TestCase):
    ...
    def test_lt_zero(self) -> None:
        with self.assertRaises(ValueError):
            health.monthly_probability_to_annual_rate(np.array([0.0, 0.5, -1.0]))

    def test_gt_one(self) -> None:
        with self.assertRaises(ValueError):
            health.monthly_probability_to_annual_rate(np.array([0.0, 0.5, 1.5]))
