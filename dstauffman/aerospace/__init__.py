...
from .quat       import QUAT_SIZE, USE_ASSERTIONS, quat_assertions, qrot, quat_angle_diff, \
                            quat_from_euler, quat_interp, quat_inv, quat_mult, quat_norm, \
                            quat_prop, quat_times_vector, quat_to_dcm, quat_to_euler
from .vectors    import rot, drot, vec_cross, vec_angle
