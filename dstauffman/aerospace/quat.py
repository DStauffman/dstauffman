...
import doctest
import logging
from typing import Final, NotRequired, TYPE_CHECKING, TypedDict, Unpack
import unittest
...
def enforce_pos_scalar(quat: _Q, inplace: bool = False) -> _Q:
    r"""
...
def quat_times_vector(quat: _Q, v: _N) -> _Q:
    r"""
