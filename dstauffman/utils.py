...
# %% Functions - rms
@overload
def rms(data: ArrayLike, axis: None = ..., keepdims: bool = ..., ignore_nans: bool = ...) -> np.floating: ...
@overload
...
# %% Functions - rss
@overload
def rss(data: ArrayLike, axis: None = ..., keepdims: bool = ..., ignore_nans: bool = ...) -> np.floating: ...
@overload
...
@overload
def modd(x1: ArrayLike, x2: ArrayLike, /, out: None) -> None: ...
@overload
