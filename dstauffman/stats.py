...
@overload
def prob_to_rate(prob: float, time: float) -> float: ...
@overload
def prob_to_rate(prob: _N, time: float) -> _N: ...
def prob_to_rate(prob: float | _N, time: float = 1) -> float | _N:
    r"""
...
@overload
def rate_to_prob(rate: float, time: float) -> float: ...
@overload
def rate_to_prob(rate: _N, time: float) -> _N: ...
def rate_to_prob(rate: float | _N, time: float = 1) -> float | _N:
    r"""
