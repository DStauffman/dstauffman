...
SET PYTHONPATH=%scripts_home%\..;%scripts_home%\..\..\nubs;%scripts_home%\..\..\slog;%scripts_home%\..\..\dstauffman2;%PYTHONPATH%
SET PYTHONPATH=%PYTHONPATH%;%scripts_home%\..\..\aoc_2023\support\python;
